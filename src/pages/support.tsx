  ...
  return (
    <NavigationProvider categories={props.categories}>
      ...
      <TopnavLayout className={`${styles.container} markdown`} title="Support useWeb3" hideNewsletter>
        <section>
          <p>
            useWeb3 has a very diverse, globally distributed community of Web3-/crypto curious. A technical audience, including designers, researchers and other builders (e.g community builders, content creators, founders, etc..).
          </p>
          <p>
        ...
        <section>
          <h3>Content</h3>
          <p>
            All the content on useWeb3 is <Link href='https://github.com/wslyvh/useWeb3/tree/main/content'>open and available on GitHub</Link>. If you have any resources, videos, guides or other content that you want to promote, feel free to submit a PR.
          </p>
          <p>
        ...
        <section>
          <h3>Jobs</h3>
          <p>
            The job board has been one of the most popular sections of the site since it launched. You can submit jobs posting at <Link href='https://www.useweb3.xyz/jobs/post'>https://www.useweb3.xyz/jobs/post</Link>.
          </p>
          <p>
            <Pricing />
          </p>
        ...
        <section>
          ...
          <p>
            All payments can be be made using ETH/DAI/UDSC on Mainnet/Arbitrum/Optimism
          </p>
          <p>
          ...
          <ul>
            <li>Address: <Link href={`https://etherscan.io/address/${RECEIVER_ADDRESS}`}>{RECEIVER_ADDRESS}</Link></li>
            <li>ENS: <Link href={`https://etherscan.io/enslookup-search?search=${RECEIVER_ENS}`}>{RECEIVER_ENS}</Link></li>
            <li><Link href={GITCOIN_GRANT}>Gitcoin Grants</Link></li>
          </ul>
        </section>
        ...
        <section>
          <h3>Thank you!</h3>
          <p>
            Thank you so much for your consideration and support.<br />
            useWeb3 is a bootstrapped, indie-project by <Link href='https://twitter.com/wslyvh'>@wslyvh</Link>. Your support helps to on-board more devs into the Web3/crypto ecosystem.
          </p>
          <p>🙏 Wesley</p>
        </section>
      </TopnavLayout>
