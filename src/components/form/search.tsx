...
export function Search(props: Props) {
    ...
    return (
        <div className={className}>
            <label className={styles.header} htmlFor='findCompany'>Find Company</label>
            <span className={styles.info}>If you've added your company before, you can search for it and skip this step.</span>

            <div className="fixed wrapper block">
                <input onChange={(e) => onChange(e.target.value)} autoComplete='off'
                    placeholder='Search for your company..' name='findCompany' id='findCompany' />
            </div>
